...
export function LoginForm({ initialUsername, prefillEmail, prefillPassword }: LoginFormProps) {
          ...
          <CardContent className="grid gap-6 p-6">
            <div className="grid gap-3">
              ...
              <Input
                ...
                defaultValue={initialUsername || prefillEmail}
                required
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <Checkbox 
                    id="remember" 
                    name="remember" 
                    defaultChecked={!!initialUsername}
                  />
                  <label
                    htmlFor="remember"
