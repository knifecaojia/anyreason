...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('draft', 'active', 'archived', name='canvas_status_enum', create_type=False), server_default="'draft'", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('pending', 'running', 'completed', 'failed', name='canvas_node_status_enum', create_type=False), server_default="'pending'", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('gen_random_uuid()'), nullable=False),
        sa.Column('canvas_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('trigger_type', postgresql.ENUM('manual', 'batch', 'auto', name='canvas_trigger_type_enum', create_type=False), server_default="'manual'", nullable=False),
        sa.Column('status', postgresql.ENUM('pending', 'running', 'completed', 'partial', 'failed', 'cancelled', name='canvas_execution_status_enum', create_type=False), server_default="'pending'", nullable=False),
