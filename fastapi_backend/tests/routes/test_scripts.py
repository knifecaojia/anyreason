...
@pytest.mark.asyncio
async def test_scripts_create_list_download(test_client, authenticated_user, mock_minio):
...
@pytest.mark.asyncio
async def test_scripts_soft_delete_hides_from_list_and_blocks_download(test_client, authenticated_user, mock_minio):
